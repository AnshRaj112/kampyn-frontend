        ...
        <div className="fixed inset-0 z-[9999] bg-[var(--background-color,#D6E6F3)] flex h-screen overflow-hidden animate-in fade-in duration-500">
            ...
            <main className="flex-1 overflow-y-auto">
                ...
                <div className="fixed bottom-12 right-12 flex flex-col items-end gap-3">
                    <span className="text-indigo-900/40 text-sm font-medium tracking-widest uppercase animate-pulse">
                        Accessing University Portal
                    </span>
                    <div className="w-32 h-1 bg-white/20 rounded-full overflow-hidden">
                        <div className="h-full bg-indigo-500/40 w-1/2 animate-[shimmer_2s_infinite]" />
                    </div>
                </div>
            </main>
        </div>
